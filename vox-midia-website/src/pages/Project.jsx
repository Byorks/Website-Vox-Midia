 ...
 // Tenho que criar uma estrutura para inserir o alt dinamicamente 
  ...
  let content = ( 
    project.images.map((image, i) => (
      <div className="w-full min-h-64 aspect-square m-auto border-vox-5 border-[.5px]">
        <img className={`w-full h-full object-cover ${i == 0 ? "rounded-t-[3.5px]" : undefined} ${project.images.length -1 == i ? "rounded-b-[3.5px]" : undefined} `} src={image} alt="" />
      </div>
    ...
    <main>
      <section className="w-full m-auto container lg:max-w-4/5 px-4 sm:px-12 lg:px-6 py-16">
        <div className="w-full m-auto">
          ...
          <div className="w-full h-auto min-h-64 aspect-square md:aspect-2/1 m-auto bg-vox-2 border-vox-5 border-[.5px] rounded-vox-5 bg-vox-3 p-3">
